...
CREATE TABLE product (
	id integer GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
	rufs_group integer references rufs_group NOT NULL, -- replace to camex_ncm
	ncm integer references camex_ncm,
...
CREATE TABLE service (
    ...
    unit character varying(255) NOT NULL DEFAULT 'UN',
...
CREATE TABLE request (
	...
	person integer NOT NULL references person, -- emitente/fornecedor
	person_dest integer NOT NULL references person, -- destinatario/tomador, default para o primeiro cadastro de person para esta rufs_group_owner
...
CREATE TABLE request_service (
    ...
    PRIMARY KEY(rufs_group_owner,id),
    FOREIGN KEY(rufs_group_owner,request) REFERENCES request(rufs_group_owner, id),
    FOREIGN KEY(rufs_group_owner,employed) REFERENCES employed(rufs_group_owner, id)
);
